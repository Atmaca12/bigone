...
$kullanicisor->execute(array(
  'mail' => $_SESSION['userkullanicigiris']
  ));
							  ...
							  <?php 
								  ...
								  <a href="#" id="reg" class="btn btn-default btn-dark">giriş yap<span>-- yada --</span>kayıt ol</a>
									<?php } else { ?>
										...
										<a href="#" id="reg" class="btn btn-default btn-dark">Hoşgeldiniz<span>----</span><?php echo $kullanicicek['kullanici_adsoyad'] ?></a>
  									...
  									<div class="row">
  										<div class="col-md-6 regform">
  											...
  											<form role="form" action="nedmin/netting/islem.php" method="POST">
  												...
  												<div class="form-group">
  													<button type="submit" name="kullanicigiris" class="btn btn-default btn-red btn-sm">Oturum aç</button>
  												</div>
											  </form>
  										...
  										<div class="col-md-6">
  											...
  											<p>
  												yeni kullanıcı? hesap acarak dahah hızlı alısveris yap, bir siparişin durumu hakkında güncel olun
  											</p>
  											<a href="register.php"><button class="btn btn-default btn-yellow">simdi kayıt ol</button></a>
  										</div>
  									</div>
  								</div>
  								<div class="srch-wrap">
  						...
  						<div class="col-md-10">
  							...
  							<div class="navbar-collapse collapse">
  								<ul class="nav navbar-nav">
  									<li><a href="test.php" class="active">Home</a><div class="curve"></div></li>
  									<li class="dropdown menu-large">
  										  <?php 
                        //order by = menu siradan emir alma limit 5 = 5 tane kategori eklemesini saglama
